...
import { getFirestore, collection, addDoc, getDocs,deleteDoc, doc ,updateDoc, query,getDoc, where} from "firebase/firestore";
...
export { collection, addDoc, getDocs ,deleteDoc, doc, updateDoc , query,getDoc, where}